...
public:
    ...
    void cloudHandler(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        // std::cout << "0:"<<laserCloudMsg->data.size() << std::endl;
        // std::vector<int> tmp_index;
        // pcl::PointCloud<PointType> tmpCloudIn, tmpCloudOut;
        // pcl::fromROSMsg(*laserCloudMsg, tmpCloudIn);        
        // pcl::removeNaNFromPointCloud(tmpCloudIn, tmpCloudOut, tmp_index);
        // sensor_msgs::PointCloud2 tempCloud;
        // pcl::toROSMsg(tmpCloudOut, tempCloud);
        // tempCloud.header = laserCloudMsg->header;
    ...
    bool cachePointCloud(const sensor_msgs::PointCloud2& laserCloudMsg)
    {
        ...
        // std::cout << laserCloudMsg.data.size() << std::endl;
        // convert cloud
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            // float angle = atan(thisPoint.z / sqrt(thisPoint.x * thisPoint.x + thisPoint.y * thisPoint.y)) * 180 / 3.14159;
            // int scanID = 0;
            ...
            // int rowIdn = scanID;
            // std ::cout << laserCloudIn->points[i].ring << std:: endl;
        ...
        // std::cout << "2:"<<fullCloud->points.size() << std::endl;
    }
    ...
    void cloudExtraction()
    {
        ...
        // std::cout << "3:"<<extractedCloud->points.size() << std::endl;
    }
